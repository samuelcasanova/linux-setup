...
if [ "$direction" = "up" ]; then
    ...
    result=$(echo 192.168.150.0/24, 192.168.190.0/24, $(nslookup tooling-alb-tf-1316935705.eu-west-1.elb.amazonaws.com | grep "Address" | tail -n +2 | awk '{printf $0 "/32"}' | sed 's/Address:/,/g' | sed 's/#[0-9][0-9]//g' | cut -c3-), $(nslookup dot-air.com | grep "Address" | tail -n +2 | awk '{printf $0 "/32"}' | sed 's/Address:/,/g' | sed 's/#[0-9][0-9]//g' | cut -c3-), $(nslookup api.dot-air.com | grep "Address" | tail -n +2 | awk '{printf $0 "/32"}' | sed 's/Address:/,/g' | sed 's/#[0-9][0-9]//g' | cut -c3-), $(nslookup dev.iag-bsa.com | grep "Address" | tail -n +2 | awk '{printf $0 "/32"}' | sed 's/Address:/,/g' | sed 's/#[0-9][0-9]//g' | cut -c3-), $(nslookup development-kibana.iag-bsa.com | grep "Address" | tail -n +2 | awk '{printf $0 "/32"}' | sed 's/Address:/,/g' | sed 's/#[0-9][0-9]//g' | cut -c3-), $(nslookup production-eks-kibana.iag-bsd.com | grep "Address" | tail -n +2 | awk '{printf $0 "/32"}' | sed 's/Address:/,/g' | sed 's/#[0-9][0-9]//g' | cut -c3-), $(nslookup com-mob-b2b.us.canary.viasat.com | grep "Address" | tail -n +2 | awk '{printf $0 "/32"}' | sed 's/Address:/,/g' | sed 's/#[0-9][0-9]//g' | cut -c3-), $(nslookup monitoring.iag-bsa.com | grep "Address" | tail -n +2 | awk '{printf $0 "/32"}' | sed 's/Address:/,/g' | sed 's/#[0-9][0-9]//g' | cut -c3-))
