...
xdg-open https://github.com/nvm-sh/nvm?tab=readme-ov-file#installing-and-updating &> /dev/null
read -p 'Paste the current NVM version (i.e. 0.40.0): ' NVM_VERSION
echo -e "Downloading from https://raw.githubusercontent.com/nvm-sh/nvm/v${NVM_VERSION}/install.sh"
